// https://content.codecademy.com/PRO/independent-practice-projects/credit-card-checker/diagrams/cc%20validator%20diagram%201.svg?_gl=1*10impet*_ga*MTkwMjQ0ODYxNy4xNjUxNDkxNTE0*_ga_3LRZM6TM9L*MTY1NDE2Mjg4Ny42LjEuMTY1NDE2MjkxNi4zMQ..
...
const validateCred = (array) => {
  ...
  const arraySum = newArray.reduce((a, b) => {
    return a + b
  })
  ...
  for (const array of nestedArray) {
    switch (array[0]) {
      ...
      case 4:
        ...
        break;
      case 5:
        if (cardCompanies.includes('Mastercard') === false) {
